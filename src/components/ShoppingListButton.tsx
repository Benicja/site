  ...
  return (
    <>
      <div className={`relative group ${className}`}>
        <button
          className="relative w-8 h-8 rounded-full overflow-hidden border border-gray-100 hover:border-gray-900 transition-colors focus:outline-none bg-black/80 text-white"
