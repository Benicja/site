...
export default function PWAInstallBanner() {
  ...
  return (
    <div className="bg-gray-100 border-b border-gray-200 py-3 px-4 flex items-center justify-between animate-fade-in relative z-50">
      <div className="flex items-center gap-3">
        ...
        <p className="text-sm font-medium text-gray-900 pr-4">
          You can now get the <span className="font-bold font-serif italic text-black">Benicja App</span> on Mobile
        </p>
      </div>
